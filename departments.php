...
<main>
        <div class="container">
            <div class="departmentMain-wraper">
                <div class="title-search">
                    <div class="title">
                        <h2>Departments</h2>
                    </div>
                    <form class="search-department" action="" class="search">
                        <input type="text" placeholder="Search departament...">
                        <div class="button">
                            <button type="submit">
