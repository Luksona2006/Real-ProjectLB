...
<main>
        <div class="container">
            <div class="main-wraper">
                <div class="contactus-wraper">
                    ...
                    <form onsubmit="sendEmail(); reset(); return false;" class="contact-us">
                        ...
                        <div class="date-datetime">
                            <div>
                                <h4>Date</h4>
                                <input id="date" type="date" placeholder="MM/DD/YY" required>
                            </div>
                            <div>
                                <h4>Time</h4>
                                <input id="time" id="time" type="time" placeholder="HH-MM" required>
                            </div>
                        </div>
                        <div class="message">
                            <div>
                    ...
                    <div class="contactUs-button">
                        <button type="submit">
                            Send <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.7832 0.21751C17.682 0.116765 17.5541 0.0470131 17.4146 0.0164552C17.2751 -0.0141027 17.1298 -0.0041961 16.9957 0.0450103L0.495733 6.04501C0.353434 6.09898 0.230923 6.19497 0.144471 6.32023C0.0580196 6.44548 0.0117188 6.59407 0.0117188 6.74626C0.0117188 6.89845 0.0580196 7.04704 0.144471 7.17229C0.230923 7.29755 0.353434 7.39354 0.495733 7.44751L7.69573 10.3275L10.5757 17.5275C10.6298 17.6636 10.7226 17.7808 10.8425 17.8648C10.9625 17.9487 11.1044 17.9957 11.2507 18C11.4023 17.9969 11.5494 17.9479 11.6725 17.8596C11.7957 17.7712 11.8892 17.6476 11.9407 17.505L17.9407 1.00501C17.9918 0.872318 18.0042 0.727833 17.9763 0.588403C17.9484 0.448973 17.8814 0.320343 17.7832 0.21751ZM11.2507 15.15L9.15823 9.90001L12.7507 6.30751L11.6932 5.25001L8.07073 8.87251L2.85073 6.75001L15.9982 2.00251L11.2507 15.15Z" fill="#039ED6"/>
                                </svg>
    ...
    <script>
        function sendEmail() {
            ...
            Body : "Name" + document.getElementById("name").value + "" + document.getElementById("lastName").value 
                + "<br> Date&Time" + document.getElementById("date").value + "" + document.getElementById("time").value 
