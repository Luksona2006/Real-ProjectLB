...
<head>
    ...
    <meta name="keyword"  content="Hospital,  Sailors, Medical center, Batumi hospital, საავადმყოფო, სამედიცინო ცენტრი, საოჯახო სამედიცინო ცენტრი, Клиника в Батуми, Поликлиника, Поликлиника Моряков, Семейный Медицинский Центр">
...
<header>
    ...
    <main>
        <div class="container">
            <div class="doctorsMain-wraper">
                <div class="title-search">
                    <div class="title"> 
                        <h2>Our Doctors</h2>
                    </div>
                    <div class="searches">
                        <form class="choose-department" action="" class="search">
                            <select name="format" id="format">
                                <option selected disabled>Choose By Departments </option>
                                <option value="allergology">Allergology</option>
                                <option value="cardiac surgery">Cardiac Surgery</option>
                                <option value="arthritis center">Arthritis Center</option>
                                <option value="arrhythmology">Arrhythmology</option>
                            </select>
                            <div class="button">
                                <button type="menu">
                                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.9993 8C7.76565 8.00046 7.53921 7.91908 7.3593 7.77L1.3593 2.77C1.15508 2.60026 1.02666 2.35635 1.00228 2.09192C0.977899 1.8275 1.05956 1.56422 1.2293 1.36C1.39904 1.15578 1.64295 1.02736 1.90738 1.00298C2.1718 0.978601 2.43508 1.06026 2.6393 1.23L7.9993 5.71L13.3593 1.39C13.4616 1.30694 13.5793 1.2449 13.7056 1.20747C13.832 1.17004 13.9645 1.15795 14.0955 1.17189C14.2265 1.18582 14.3535 1.22552 14.4691 1.2887C14.5848 1.35187 14.6868 1.43727 14.7693 1.54C14.8609 1.64282 14.9302 1.76345 14.973 1.89432C15.0158 2.0252 15.0311 2.1635 15.018 2.30056C15.0048 2.43762 14.9635 2.5705 14.8967 2.69085C14.8298 2.81121 14.7387 2.91646 14.6293 3L8.6293 7.83C8.44422 7.95552 8.2224 8.01537 7.9993 8V8Z" fill="#039ED6"/>
                                    </svg>
                                </button>
                            </div>                                
                        </form>
                        <form class="search-doctor" action="" class="search">
                            <input type="text" placeholder="Search doctor...">
                            <div class="button">
                                <button type="submit">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.0205 21.0208L17.0387 16.8088C18.6224 15.1685 19.5515 13.0055 19.6507 10.7275C19.7499 8.44955 19.0125 6.21397 17.5773 4.44213C16.1422 2.67029 14.1086 1.48458 11.8597 1.10849C9.61079 0.732399 7.30199 1.1919 5.36847 2.40039C3.43494 3.60888 2.01023 5.48288 1.36288 7.66917C0.715526 9.85547 0.890237 12.2031 1.85408 14.2694C2.81793 16.3358 4.50434 17.9783 6.59545 18.8873C8.68656 19.7962 11.0379 19.9089 13.2064 19.2041" stroke="#039ED6" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                            </div>
                        </form>
                ...
                <div class="doctors-wraper">
                    <div class="doctors"> 
                        <img src="image-doctors/doctor-img.png" alt="doctors img">
                        <div class="doctors-info">
                            <h4>Dr. Kimberly Mastrangelo</h4>
                            <p>Cardiac Surgery</p>
                            <a href="#"><button>Read More</button></a>
                        </div>
                    </div>
                    <div class="doctors"> 
                        <img src="image-doctors/doctor1-img.png" alt="doctors img">
                        <div class="doctors-info">
                            <h4>Dr. Kimberly Mastrangelo</h4>
                            <p>Cardiac Surgery</p>
                            <a href="#"><button>Read More</button></a>
                    ...
                    <div class="doctors"> 
                        <img src="image-doctors/doctor2-img.png" alt="doctors img">
                        <div class="doctors-info">
                            <h4>Dr. Kimberly Mastrangelo</h4>
                            <p>Cardiac Surgery</p>
                            <a href="#"><button>Read More</button></a>
                    ...
                    <div class="doctors"> 
                        <img src="image-doctors/doctor3-img.png" alt="doctors img">
                        <div class="doctors-info">
                            <h4>Dr. Kimberly Mastrangelo</h4>
                            <p>Cardiac Surgery</p>
                            <a href="#"><button>Read More</button></a>
