...
<head>
    ...
    <meta name="keyword"
        content="Hospital,  Sailors, Medical center, Batumi hospital, საავადმყოფო, სამედიცინო ცენტრი, საოჯახო სამედიცინო ცენტრი, Клиника в Батуми, Поликлиника, Поликлиника Моряков, Семейный Медицинский Центр">
    <meta name="authors" content="Givi vakhtangishvilli, Luka Bakuridze">
...
<body>
    ...
    <main>
        <div class="container">
            <div class="aboutUsMain-wraper">
                <div class="title">
                    <h2>About Us</h2>
                </div>
                <div class="text-box">
                    <p>
                        The American Hospital Tbilisi was founded with the support of the United States International
                        Development Finance Corporation (DFC) and in conformity with Georgian state interests. The
                        project
                        is the result of a $ 50 million foreign direct investment implemented based on the agreement
                        between
                        the United States and Georgia. The stakeholders are the Georgian Ministry of Economy and
                        Sustainable
                        Development, the US Agency for International Development Finance Corporation, together with a
                        number
                        of medical institutions interested in medical and scientific research.
                        According to agreement reached between 2011 and 2015, the Georgian Government sold the
                        state-owned
                        real estate (former medical institutions) located at 58 Uznadze / 17 Chkheidze, in the center of
                        Tbilisi. By this action, Georgia expressed its desire and interest in establishing a new,
                        international standardized hospital in Georgia which will be second to none in the region of
                        Caucasus. One of the conditions for this agreement obliged Georgian state to invest at least 18
                        million USD. <br>
                        <br>
                        American Hospital Tbilisi has 183 beds (wards), a total area of 25000 sqm, providing services in
                        accordance with international standards. The hospital operates on a modern governance model that
                        emphasizes patient-centered, high-quality medical care. This truly reflects the ambition of AHT
                        to
                        set a new landmark on the map of Georgian medical services. This will establish Georgia's first
                        global ranked hospital, which will be fully accredited by Joint Commission International. About
                        JCI
                        accreditation JCI is an independent, non-profit organization that evaluates healthcare
                        organizations
                        worldwide and grants accreditation to high standards. JCI accreditation is recognized as a
                        global
                        leader in healthcare quality and patient safety. Centers of Excellence One of the most
                        significant
                        and ambitious medical concepts of AHT is the Centers of Excellence. These are specialized
                        centers
                        focused on the health and life of each individual. The centers are headed by the high-class
                        professionals of Georgian medicine and with their
                    </p>
                    <ul>
                        <a href="#">
                            <li>
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M5.54146 5.54146L11.3748 11.3748M2.20812 8.87479L8.87479 2.20812C9.64834 1.43457 10.6975 1 11.7915 1C12.8854 1 13.9346 1.43457 14.7081 2.20812C15.4817 2.98167 15.9162 4.03083 15.9162 5.12479C15.9162 6.21875 15.4817 7.26791 14.7081 8.04146L8.04146 14.7081C7.26791 15.4817 6.21875 15.9162 5.12479 15.9162C4.03083 15.9162 2.98167 15.4817 2.20812 14.7081C1.43457 13.9346 1 12.8854 1 11.7915C1 10.6975 1.43457 9.64834 2.20812 8.87479Z"
                                        stroke="#0C2D6C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <a href="#">
                            <li>
                                ...
                                <h5>Professionalism and Teamwork</h5>
                            </li>
                        </a>
                        <a href="#">
                            <li>
                    ...
                    <p>
                        <span>Mission and Vision</span>Our mission is to lead with innovation, delivering patient-centered,
                        evidence-based healthcare, reflecting international accreditation standards. Our vision for the
                        future is to drive the evolution of Georgian healthcare to become the most trusted healthcare
                        provider, ensuring lifelong health and well-being for our patients. Our Values
                    </p>
                    <ul>
                        <a href="#">
                            <li>
